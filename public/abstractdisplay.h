...
#ifndef PUBLIC_ABSTRACTDISPLAY_H
#define PUBLIC_ABSTRACTDISPLAY_H
...
public:
    ...
    virtual void            copyDisplayTimings( std::vector<Timing>& timings ) const = 0;
    ...
    virtual HWCString         dump( void ) const = 0;
};


}; // namespace hwcomposer

#endif // COMMON_DISPLAY_ABSTRACTDISPLAY_H
