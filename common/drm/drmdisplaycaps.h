...
#ifndef COMMON_DRM_DISPLAY_CAPS_DRM_H
#define COMMON_DRM_DISPLAY_CAPS_DRM_H
...
public:
    ...
    HWCString displayCapsString( void ) const;
...
#endif // COMMON_DRM_DISPLAY_CAPS_DRM_H
