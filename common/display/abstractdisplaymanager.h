...
#ifndef COMMON_DISPLAY_ABSTRACTDISPLAYMANAGER_H
#define COMMON_DISPLAY_ABSTRACTDISPLAYMANAGER_H
...
public:
    ...
    virtual HWCString             dump( void ) = 0;

    // Dump detailed info about the display state.
    virtual HWCString             dumpDetail( void ) = 0;
};

}; // namespace hwcomposer

#endif // COMMON_DISPLAY_ABSTRACTDISPLAYMANAGER_H
