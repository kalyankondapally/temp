...
void DisplayCaps::PlaneCaps::updateCSCFormats( void )
{
    ...
    {
	mCSCFormat[ CSC_CLASS_RGBX ] = DRM_FORMAT_XBGR8888;
    ...
    if ( isDisplayFormatSupported( DRM_FORMAT_XBGR8888 ) )
    {
	mCSCFormat[ CSC_CLASS_RGBX ] = DRM_FORMAT_XBGR8888;
    }
    ...
    if ( mPrioritizeNV12Y && isDisplayFormatSupported( DRM_FORMAT_NV12 ) )
    {
	mCSCFormat[ CSC_CLASS_YUV8 ] = DRM_FORMAT_NV12;
    }
    else if ( isDisplayFormatSupported( HWC_PIXEL_FORMAT_NV12_X_TILED_INTEL ) )
    {
	mCSCFormat[ CSC_CLASS_YUV8 ] = HWC_PIXEL_FORMAT_NV12_X_TILED_INTEL;
    }
    else if ( isDisplayFormatSupported( DRM_FORMAT_YUYV ) )
    {
	mCSCFormat[ CSC_CLASS_YUV8 ] = DRM_FORMAT_YUYV;
    }
    else if ( isDisplayFormatSupported( DRM_FORMAT_NV12 ) )
    {
	mCSCFormat[ CSC_CLASS_YUV8 ] = DRM_FORMAT_NV12;
    }
    ...
    if (/* TODO: is10bppPanel() && */ isDisplayFormatSupported( DRM_FORMAT_ARGB2101010 ) )
    {
	mCSCFormat[ CSC_CLASS_YUV16 ] = DRM_FORMAT_ARGB2101010;
    }
    else if ( isDisplayFormatSupported( DRM_FORMAT_ABGR2101010 ) )
    {
	mCSCFormat[ CSC_CLASS_YUV16 ] = DRM_FORMAT_ABGR2101010;
    }
    else
    {
...
DisplayCaps::ECSCClass DisplayCaps::halFormatToCSCClass( int32_t halFmt, bool forceOpaque )
{
	...
	case DRM_FORMAT_R8:
	case HWC_PIXEL_FORMAT_FLEX_IMPLEMENTATION_DEFINED:
