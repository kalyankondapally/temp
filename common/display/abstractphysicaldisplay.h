...
#ifndef COMMON_DISPLAY_ABSTRACTPHYSICALDISPLAY_H
...
public:
    ...
    // Set all modes.
    virtual void        setDisplayTimings( std::vector<Timing>& timings ) = 0;
...
#endif // COMMON_DISPLAY_ABSTRACTPHYSICALDISPLAY_H
