...
class Singleton : NonCopyable {
 public:
  // This function should be inlined as much as possible. The first access
  // should
 ...
 private:
  // This function does not want to be inlined. This saves 23 instructions of
  // assembly per getInstance call.
...
template <typename TYPE>
TYPE* Singleton<TYPE>::spInstance;

};  // namespace hwcomposer

#endif  // COMMON_CORE_SINGLETON_H_
